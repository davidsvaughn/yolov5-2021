...
def plot_one_box(x, img, color=None, label=None, line_thickness=None, yoff=0, xoff=0):
    ...
    tl = line_thickness or round(0.002 * (img.shape[0] + img.shape[1]) / 6) + 1  # line/font thickness
